...
class GroupNotFound(falcon.HTTPNotFound):
...
class GroupExists(falcon.HTTPConflict):
    ...
    def __init__(self, group_name):
        description = (
            'Group {} already exist, please create another group!'.format(group_name)
        )
        super().__init__(description=description)
    ...
    def to_dict(self, obj_type=dict):
        ...
        result["exists"] = True
        result["group_name"] = self._group_name
        return result
...
class MemberExists(falcon.HTTPConflict):
    ...
    def __init__(self, member):
        description = (
            'Member {} already exist!'.format(member)
        )
        super().__init__(description=description)
        self.member = member
