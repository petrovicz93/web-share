...
g.add_argument("--app-name", type=str, default="amera_api",
...
g.add_argument("--environment-variables-prefix", type=str, default="amera_api",
...
gu.add_argument("--workers", type=int, default=0,
               help="The number of worker processes for handling requests. "
                    ...
                    "(default %(default)s)")
gu.add_argument("--reload", action="store_true",
               help="Watch for file changes and reload. "
                    "(default %(default)s)")

# Middleware
m = p.add_argument_group("Middleware")
m.add_argument("--access-control-allow-origin", type=str, default="auto",
